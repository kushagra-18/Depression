...
st.markdown("<h1> Know it all: </h1>", unsafe_allow_html=True)
...
st.markdown("<body style='text-align: center'> <b>Created by Team Techwayy</b><br>", unsafe_allow_html=True)
